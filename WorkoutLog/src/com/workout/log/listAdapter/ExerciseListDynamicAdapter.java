...
import com.workout.log.DynamicListView;
...
public class ExerciseListDynamicAdapter extends ArrayAdapter<Exercise> {
	public ExerciseListDynamicAdapter(Context context, int textViewResourceId, List<Exercise> objects) {
